...
export default async function AdminCustomersPage({
  ...
  return (
    <AdminShell
      ...
      subtitle={
        locale === "hi"
          ? "कस्टमर प्रोफाइल, दूध की मात्रा और बकाया रिकॉर्ड अब live database से."
          : "Manage customer profiles, milk quantities, and outstanding balances from live database records."
      }
    >
      <AdminCard>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--admin-muted)]">
                    Code • {customer.customerCode} • {customer.areaCode} • {customer.deliverySlot}
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
              <div className="flex flex-wrap gap-2 text-sm text-[var(--admin-muted)]">
                ...
                <span className="admin-panel-muted rounded-full px-3 py-1.5">
                  {customer.notes ? "Notes available" : "No note"}
                </span>
              </div>
